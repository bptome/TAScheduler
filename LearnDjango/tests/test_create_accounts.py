...
import TAInformation.Models.user
...
def setup_database(test_user: TAInformation.Models.user.User, test_user_model: User):
    ...
    test_user_model.role = test_user.getRoleAsInt()
...
class CreateAccountsAsAdmin(unittest.TestCase):
    ...
    def test_CreateInstructor(self):
        ...
        self.assertTrue(self.testAdmin.createInstructor(new_instructor), failure_msg)
...
class CreateAccountsAsInstructor(unittest.TestCase):
    ...
    def test_CreateAdmin(self):
        ...
        self.assertFalse(self.testInstructor.createAdmin(new_admin), failure_msg)
    ...
    def test_CreateInstructor(self):
        ...
        self.assertFalse(self.testInstructor.createInstructor(new_instructor), failure_msg)
...
class CreateAccountsAsTA(unittest.TestCase):
    ...
    def test_CreateAdmin(self):
        ...
        failure_msg = "Created admin account despite not being an admin"
        self.assertFalse(self.testTA.createAdmin(new_admin), failure_msg)
    ...
    def test_CreateInstructor(self):
        ...
        all_tests_setup(new_instructor, 3, "firstInstructor", "fI0$", "firstInstructor@test.com",
                        "11111 W. North Ave, Wauwatosa, WI 53219", "(414)445-9870")
        failure_msg = "Created instructor account despite not being an admin"
        self.assertFalse(self.testTA.createInstructor(new_instructor), failure_msg)
...
class CheckCredentials(unittest.TestCase):
    ...
    def test_GoodNameGoodPassword(self):
        ...
        self.assertTrue(self.testAdmin.createTA(test_ta), failure_msg)
...
class CreateDuplicateAccounts(unittest.TestCase):
    ...
    def test_CreateExactDuplicate(self):
        ...
        self.assertFalse(self.testAdmin.createAdmin(self.testAdmin), failure_msg)
    ...
    def test_AccountWithDuplicateID(self):
        ...
        self.assertFalse(self.testAdmin.createAdmin(new_admin), failure_msg)
