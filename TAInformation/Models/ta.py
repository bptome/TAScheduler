...
class TA(BaseUser):
    ...
    def edit_email(self, user_to_edit: User, new_email: str):
        if user_to_edit.user_id != self.user_id:
            return {'result': False, 'message': "TAs can only edit their own email address\n"}
    ...
    def edit_password(self, user_to_edit: User, new_password: str):
        if user_to_edit.user_id != self.user_id:
            return {'result': False, 'message': "TAs can only edit their own password\n"}
    ...
    def edit_home_address(self, user_to_edit: User, new_address: str):
        if user_to_edit.user_id != self.user_id:
            return {'result': False, 'message': "TAs can only edit their own home address\n"}
    ...
    def edit_phone(self, user_to_edit: User, new_phone: str):
        if user_to_edit.user_id != self.user_id:
            return {'result': False, 'message': "TAs can only edit their own phone number\n"}
    ...
    def edit_role(self, user_to_edit: User, new_role: int):
        return {'result': False, 'message': "TAs can\'t change anyone\'s role\n"}
